  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Tab Switcher */}
        <div className="mb-6 flex gap-3 bg-white border border-slate-200 rounded-xl p-1.5 shadow-sm">
          <button
            onClick={() => setActiveTab('practice')}
            className={`flex-1 px-4 py-2.5 rounded-lg font-semibold transition-all ${
              activeTab === 'practice' 
                ? 'bg-primary-500 text-white shadow-sm' 
                : 'text-slate-600 hover:text-neutral-900 hover:bg-slate-100'
            }`}
          >
            Speaking Practice
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <section className="bg-white border border-slate-200 rounded-2xl p-6 space-y-6 shadow-card relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-6">
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-card h-[600px] flex flex-col relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-50/50 to-transparent pointer-events-none"></div>
